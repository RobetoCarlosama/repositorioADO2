            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <Fields>
                    ...
                    <asp:TemplateField HeaderText="ubicación_habitacion" SortExpression="ubicacion_habitacion">
                        ...
                        <InsertItemTemplate>
                            <asp:TextBox ID="TextBox4" runat="server" MaxLength="30" Text='<%# Bind("ubicacion_habitacion") %>'></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox4" ErrorMessage="Ubicación, campo requerido" ForeColor="Red">*</asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox4" ErrorMessage="Solo letras MAYÚSC" ForeColor="Blue" ValidationExpression="[A-Z ]*">*</asp:RegularExpressionValidator>
                        </InsertItemTemplate>
                        <ItemTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id_habitacion" DataSourceID="sqldsHabitaciones" CssClass="table-responsive table-striped table-advance table-hover" HorizontalAlign="Center" Width="100%" Height="100%" GridLines="None">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="número" SortExpression="numero_habitacion">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox1" runat="server" MaxLength="10" Text='<%# Bind("numero_habitacion") %>'></asp:TextBox>
                    ...
                    <asp:BoundField DataField="cracion_habitacion" HeaderText="cración" SortExpression="cracion_habitacion" ReadOnly="True" />
                    <asp:BoundField DataField="actualizacion_habitacion" HeaderText="actualización" SortExpression="actualizacion_habitacion" ReadOnly="True" />
